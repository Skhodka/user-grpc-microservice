...
PROTO_PATH = ./internal/transport/grpc/proto/register-ms/${PROTO_FILE}
...
build_protoc:
	rm -f ./internal/transport/grpc/pb/user_grpc.pb.go
	rm -f ./internal/transport/grpc/pb/user.pb.go
